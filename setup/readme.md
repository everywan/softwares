...
1. 必要点
  - 输入: 使用键盘梳理文章, 手写多数只是草稿.
  - 姿势: 糖床上/沙发上时. surface 不好打字. (或许360度折叠的那种方式会更好?)
2. 其他
  - tp 的小红点是加分项
  - surface 的平板模式很有吸引力, 虽然现在是 残废触屏系统, 基本只能用来 画画/触屏游戏(如麻将等)

笔记本要求
1. 必须有键盘
2. 必须是 i5/8G/256 以上, 8代cpu 以上(8代之后才是四核了).
...
### 关于OS
为什么选择 Linux?
- 说不清楚无可替代在哪里, 却喜爱不已, 可能是因为顺手吧.
- 非要问的话, 就是自由之魂, 即在自己喜欢的事物上, 想努力的抓住自己所能控制的一切吧. 其实只是当作工具对待的话, win/osx 现在都是挺好的选择, 但是我还是希望可以尽可能地自己掌控一切, 这样的要求对于 win/osx 是很难做到的.
