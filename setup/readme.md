...
对我而言, 主力机肯定是 arch/x1或台式, win只能是二奶机.
...
但是, 如果用为多功能中心, 可以考虑用surface当二奶机, 否则还是arch.
...
2. 服务器/笔记本 方案
  ...
  - 解释: 笔记本装win, 是将笔记本当成了多功能工具. 在干活时, 还是更喜欢使用arch. 但是, 其他娱乐休闲方面, 还是win更适用, win也能用来干活, 只是效率会降低些.

淘宝租赁了个 surface, 先把 x1 当成服务器, surface 作为家庭中心, 实验一下. 如果可以, 以后就用这套了. 过几天回来补说明.
