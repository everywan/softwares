...
- 键盘: 机械键盘, 至少拥有以下特性: cherry机械轴 + 至少支持有线 + pbt 键帽(防打油)
    - 双模或者有线: 无线虽然便捷, 但是不如有线稳定, 尤其是打游戏时. 不能要只支持蓝牙的, 因为不能在进bios前使用.
    - 一般人还是不要考虑 hhkb 了, 手感真的不爽. 键位可以考虑使用键位映射 或者直接买67键的.
    - 选购建议
        - 无钢板设计: cherry g80-3000, 有钢板设计: ikbc c87. (没感觉贵一倍的filco好在哪里..所以选择ikbc)
        - vim熟练后可考虑 61键 poker系列
    - 无线和灯的需求基本没必要. 暂不考虑
- 公司: 电源 + 主显示器 + 机械键盘 + 任意无线鼠标 + typec 扩展坞(方便nuc移动)
    - 主显示器: 建议4k, 27寸, IPS. 无需HDR.(土豪全都要). 4k 还是很有必要的, 看起来更细腻, 舒服, 而且字体不发虚了.
        - [arch hdpi配置](/os/arch/i3wm_config.md)
    - 优化选项: 
        - 添加从显示器: 从显示器主要用于监控, 或者边看文档边写代码, 以及其他情况, 随便1080即可. 其实在 大屏+i3wm+很少需要监控 情况下, 从显示器是作用不大了. 注意, 你至少要有个大点的办公桌, 否则摆不下.
- 家里: 电源 + 单显示器 + 机械键盘 + 任意无线鼠标 + type c 扩展坞
    - 公司配置的复制版或简化版.
- 其他
    - 经测试, 键鼠 + nuc + 电视 在家办公时没有问题的, 但是还是建议买个显示器.
