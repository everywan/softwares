...
- 公司: 电源 + 主(从)显示器 + cherry g80-3000 + 任意无线鼠标 + typec 扩展坞(方便nuc移动)
    - 主(从)显示器, 从显示器主要用于监控, 或者边看文档边写代码, 以及其他情况.
        - 主显示器: 4k, 27寸, ips, 即可, 无需HDR
        - 从显示器: 随便来个1080p的即可, 19-21寸皆可.
        - [显示器挑选教程](/search/monitor.md)
    - 键盘: 试过 hhkb 的, 太不好用了. 还是机械键盘吧. 在系统里改下键位映射, 键帽换下即可. 也可以试下 flico 的 87/60 键盘.
        - 选购建议: cherry轴, pbt键帽(不打油), 必须支持有线/免驱, 其他看喜好/需求.
